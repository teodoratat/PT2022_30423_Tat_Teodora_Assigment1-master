...
public class TestForAddition {
    ...
    public void addTest(Polynomial polynomial1, Polynomial polynomial2, String expectedResult){
        assertEquals(expectedResult, Operations.addition(polynomial1, polynomial2).toString());
    }
    private static List<Arguments> provideInput() {
        List <Arguments> argumentsList = new ArrayList<>();
        Polynomial polynomial1 = new Polynomial("X^8+2*X^5-3");
        polynomial1.isPolynomial("X^8+2*X^5-3");
        Polynomial polynomial2 = new Polynomial("-3X^5-1");
